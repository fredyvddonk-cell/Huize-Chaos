const CACHE='huize-chaos-v1-3-94';
const ASSETS=["./", "./index.html", "./style.css?v=1.3.94", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./assets/huize-chaos-wordmark-v1111.png", "./boodschappen/", "./boodschappen/index.html", "./boodschappen/style.css?v=1.3.94", "./boodschappen/js/app.js?v=1.3.94", "./boodschappen/js/shopping.js?v=1.3.94", "./boodschappen/js/stock.js?v=1.3.94", "./boodschappen/js/hutsel.js?v=1.3.94", "./boodschappen/js/insight.js?v=1.3.94", "./boodschappen/js/firebase.js?v=1.3.94", "./boodschappen/assets/shopping-icon.png", "./boodschappen/assets/huize-chaos-wordmark-v1111.png", "./gezinsplanner/", "./gezinsplanner/index.html", "./gezinsplanner/style.css?v=1.3.94", "./gezinsplanner/planner-v131.css?v=1.3.94", "./gezinsplanner/app.js?v=1.3.94", "./gezinsplanner/firebase.js?v=1.3.94", "./recepten/", "./recepten/index.html", "./recepten/style.css?v=1.3.94", "./recepten/app.js?v=1.3.94", "./recepten/recipes-data.js", "./gelegenheden/", "./gelegenheden/index.html", "./gelegenheden/style.css?v=1.3.94", "./gelegenheden/app.js?v=1.3.94"];
