...
const APP_ASSETS=['./','./index.html','./style.css?v=1.4.67','./js/app.js?v=1.4.67','./js/shopping.js?v=1.4.67','./js/stock.js?v=1.4.67','./js/hutsel.js?v=1.4.67','./js/insight.js?v=1.4.67','./js/firebase.js?v=1.4.67','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
