const CACHE_NAME='huize-chaos-boodschappen-v1-4-39';
const APP_ASSETS=['./','./index.html','./style.css?v=1.4.41','./js/app.js?v=1.4.41','./js/shopping.js?v=1.4.41','./js/stock.js?v=1.4.41','./js/hutsel.js?v=1.4.41','./js/insight.js?v=1.4.41','./js/firebase.js?v=1.4.41','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
