const CACHE_NAME='boodschappen-v1-3-71-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=1.3.72-test','./js/app.js?v=1.3.72-test','./js/shopping.js?v=1.3.72-test','./js/stock.js?v=1.3.72-test','./js/hutsel.js?v=1.3.72-test','./js/insight.js?v=1.3.72-test','./js/firebase.js?v=1.3.72-test','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
