const CACHE_NAME='huize-chaos-boodschappen-v1-4-117';
const APP_ASSETS=['./','./index.html','./style.css?v=1.4.117','./js/app.js?v=1.4.117','./js/shopping.js?v=1.4.117','./js/stock.js?v=1.4.117','./js/hutsel.js?v=1.4.117','./js/insight.js?v=1.4.117','./js/firebase.js?v=1.4.117','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
