...
const APP_ASSETS=['./','./index.html','./style.css?v=1.3.102','./js/app.js?v=1.3.102','./js/shopping.js?v=1.3.102','./js/stock.js?v=1.3.102','./js/hutsel.js?v=1.3.102','./js/insight.js?v=1.3.102','./js/firebase.js?v=1.3.102','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
