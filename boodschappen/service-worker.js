const CACHE_NAME='boodschappen-v1-3-45-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=1.3.45','./js/app.js?v=1.3.45','./js/shopping.js?v=1.3.45','./js/stock.js?v=1.3.45','./js/hutsel.js?v=1.3.45','./js/insight.js?v=1.3.45','./js/firebase.js?v=1.3.45','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
