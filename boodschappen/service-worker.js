const CACHE_NAME='boodschappen-v1-2-7-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=1.2.7','./js/app.js?v=1.2.7','./js/shopping.js?v=1.2.7','./js/stock.js?v=1.2.7','./js/hutsel.js?v=1.2.7','./js/firebase.js?v=1.2.7','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
