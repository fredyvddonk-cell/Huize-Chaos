const CACHE_NAME='boodschappen-v1-2-12-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=1.2.12','./js/app.js?v=1.2.12','./js/shopping.js?v=1.2.12','./js/stock.js?v=1.2.12','./js/hutsel.js?v=1.2.12','./js/firebase.js?v=1.2.12','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
