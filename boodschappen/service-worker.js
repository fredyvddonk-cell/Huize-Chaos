const CACHE_NAME='boodschappen-v1-4-4-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=1.4.4','./js/app.js?v=1.4.4','./js/shopping.js?v=1.4.4','./js/stock.js?v=1.4.4','./js/hutsel.js?v=1.4.4','./js/insight.js?v=1.4.4','./js/firebase.js?v=1.4.4','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
