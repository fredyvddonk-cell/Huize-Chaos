...
const STANDARD_STOCK_LAYOUT = [
  ...
  ['Kruiden',['Zout','Peper']],
  ['Schoonmaak & huishouden',['Afwasmiddel','Allesreiniger','Bleek','GFT zakken','Glansspoelmiddel','Wc papier','Pedaalemmerzakken','PMD zakken','Schuursponsjes','Stofzuigerzakken','Vaatwastabletten','Vaatwaszout','Vuilniszakken','Waspoeder','Wasverzachter']],
  ['Huisdier',['Kattenbakvulling','Kattenbrokjes','Kattensnoepjes','Natvoer']],
  ['Persoonlijke verzorging',['Handzeep','Conditioner','Deodorant','Douchegel','Excedrin','Inlegkruisjes','Maandverband/tampons','Paracetamol','Pleisters','Scheerproducten','Shampoo','Tandpasta']],
...
function openHuizeChaosOverlay(name, element) {
  ...
  // V1.4.8 - open schermen neutraal: geen invoerveld krijgt automatisch focus.
