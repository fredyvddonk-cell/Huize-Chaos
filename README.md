...
## V1.4.36 – Receptboodschappen en synchronisatie

- Receptingrediënten kunnen nu los van de boodschappenlijst worden verwijderd zonder het recept aan te passen.
- Verwijderde geplande maaltijden krijgen een synchronisatie-markering, zodat een ander apparaat ze niet opnieuw kan terugzetten.
- Weekmenu synchroniseert verwijderingen en wijzigingen tussen laptop en telefoon betrouwbaarder.

## V1.4.36 – Voorraadmatching en boodschappenlijst gecorrigeerd

- Voorraadcontrole voor naanbrood gecorrigeerd.
- Regulier en glutenvrij naanbrood worden apart herkend.
- Naanbrood uit een recept wordt niet meer aan een verkeerde variant gekoppeld.
- Voorraadmatching voor dressing aangescherpt.
- Alleen het woord “dressing” is niet meer voldoende voor een productmatch.
- Honing-Appel Dressing wordt niet meer gekoppeld aan Yoghurt dressing.
- Hoeveelheden worden pas vergeleken nadat het juiste voorraadproduct is gevonden.
- Onjuiste meldingen zoals “aanwezig · tekort” bij een verkeerd product worden voorkomen.
- Dubbele categorieën bij weekrecepten in de boodschappenlijst verwijderd.
- Receptproducten en gewone boodschappen worden binnen dezelfde categorie samengevoegd.
- Categoriekeuzelijst opent alleen wanneer je het veld gebruikt.
- Alle categorieën zijn bereikbaar via verticaal scrollen en zoeken.
- De categorielijst sluit direct na een keuze.

## V1.4.36 – Vervolgafspraak mobiel verbeterd
...
## V1.4.36 – Vervolgafspraak plannen
...
## V1.4.36 – Vandaag als rustig dagoverzicht
...
- Week én maand gebruiken nu **Reguliere boodschappen** als hoofd­bedrag voor het boodschappenbudget.
- Producten met **Niet meenemen in reguliere weekboodschappen** tellen niet mee in het hoofd­bedrag, de verdeling, percentages en categoriespecificaties.
- **Werkelijk uitgegeven** blijft apart zichtbaar.
- **Buiten reguliere boodschappen** is aanklikbaar en toont de exacte producten, bedragen, winkel, datum, categorie en eventuele memo.

# V1.4.10

- In **Inzicht → Week → categoriespecificatie** blijven producten met **Niet meenemen in reguliere weekboodschappen** nu ook na navigeren, teruggaan of opnieuw openen uitgesloten.
- De categoriespecificatie gebruikt voortaan dezelfde reguliere-weekfilter als het hoofdweekbedrag en de verdeling.

# Huize Chaos V1.4.10

- In de **weekweergave** is het grote bedrag nu **Reguliere weekboodschappen**.
- Producten met **Niet meenemen in reguliere weekboodschappen** worden niet in dit hoofd­bedrag meegerekend.
- **Werkelijk uitgegeven deze week** blijft apart zichtbaar en bevat wel alle boodschappenuitgaven.
- **Buiten reguliere weekboodschappen** blijft apart zichtbaar.
- Voorbeeld: €115 totaal waarvan €35 frituurolie gemarkeerd → hoofd­bedrag weekboodschappen €80.
...
### V1.4.15 – centrale verlanglijstjes en direct naar bonproduct
